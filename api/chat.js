...
const MARKDOWN_RULE = "หน้าจอฝั่งผู้ใช้รองรับ Markdown เต็มรูปแบบและจะแสดงผลจัดรูปแบบสวยงามจริง (หัวข้อ #, **ตัวหนา**, bullet, ตัวเลขลำดับ, ตาราง, โค้ด) — ใช้เมื่อเหมาะสมเพื่อให้อ่านง่ายขึ้น เช่น เปรียบเทียบข้อมูลใช้ตาราง, ขั้นตอนใช้ลิสต์เลข, จุดสำคัญใช้ bullet ไม่ต้องเขียนเป็นพรืดยาวๆ ทั้งหมดถ้าจัดเป็นข้อๆ จะอ่านง่ายกว่า";
