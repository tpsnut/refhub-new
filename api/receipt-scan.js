...
- suggested_category ต้องเป็นค่า "id" (ภาษาอังกฤษ ตรงตัวเป๊ะ ห้ามแปลหรือใช้ label ภาษาไทย) จากลิสต์นี้เท่านั้น: ${JSON.stringify(categoryOptions)} — เช่นถ้าลิสต์มี {"id":"food","label":"อาหาร"} แล้วเลือกอาหาร ต้องตอบ "food" ไม่ใช่ "อาหาร" — ถ้าไม่มั่นใจให้เลือก id ของรายการที่ label เป็น "อื่นๆ"
